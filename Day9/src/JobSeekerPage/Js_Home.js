...
import '../JobSeekerPage/Js_Home.css';
...
Get A Faster, Easier & Better Job Post Today
    ...
    <div>
    <nav>
    <Link to={'./but2SearchJob'}>
    <center><button className='but2'  style={{backgroundColor:'white',color:'blue',borderRadius:'25px',width:'130px',justifyContent:'center',height:'50px',padding:'8px'}}>SearchJob</button></center>
    </Link>
    </nav>
    </div>
    </div>
