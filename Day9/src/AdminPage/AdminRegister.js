                      ...
                      <div class="row">
                        <div class="col-md-9 col-lg-8 mx-auto">
                          ...
                          <div class="form-floating mb-3">
                              <input type="name" className={"form-control "} id="floatingInput" name='Name' placeholder="Enter your FirstName" value={this.state.Name} onChange={this.handleInputChange} required/>
                              <label for="floatingInput">First Name</label>
                            </div>
                            <div class="form-floating mb-3">
                            <input type="name" className={"form-control "} id="floatingInput" name='Name' placeholder="Enter your LastName"  requiredx/>
